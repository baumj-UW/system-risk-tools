...
def _read_csv(table):
   ...
   # start_path = os.path.join("RTS_Data","SourceData")
    start_path = r"C:\Users\baumj\Documents\Research New Project\Python Dev\RTS_Data/SourceData/"
    return pd.read_csv(start_path + table + ".csv") ##pd.read_csv(os.path.join(start_path, table + ".csv"))
